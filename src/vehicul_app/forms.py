...
class VehiculForm(forms.ModelForm):
    class Meta:
        ...
        fields = ["marque","modele","type_vehicule","annee", "stock",
                  "prix", "kilometrage","couleur_exterieure","couleur_interieure",
                  "motricite","sieges",
                  "etat","nombre_portes","nombre_places","version","moteur",
        ...
        widgets = {
            ...
            "motricite":forms.Select(attrs={"class":"select select-bordered w-full"}),
            "sieges":forms.Select(attrs={"class":"select select-bordered w-full"}),
            "etat":forms.Select(attrs={"class":"select select-bordered w-full"}),
            "version": forms.TextInput(attrs={"class":"input input-bordered w-full", "placeholder":"Saisir la version"}),
            "moteur": forms.TextInput(attrs={"class":"input input-bordered w-full", "placeholder":"Saisir le moteur"}),
            ...
            "nombre_portes": forms.NumberInput(attrs={"class":"input input-bordered w-full", "placeholder":"Saisir le nombre de portes"}),
            "nombre_places": forms.NumberInput(attrs={"class":"input input-bordered w-full", "placeholder":"Saisir le nombre de places"}),
            "stock":forms.NumberInput(attrs={"class":"input input-bordered w-full", "placeholder":"Saisir le stock"}),
            ...
            "couleur_exterieure": forms.TextInput(attrs={"class":"input input-bordered w-full", "type":"color", "placeholder":"Saisir la couleur extérieure"}),
            "couleur_interieure": forms.TextInput(attrs={"class":"input input-bordered w-full", "type":"color", "placeholder":"Saisir la couleur intérieure"}),
